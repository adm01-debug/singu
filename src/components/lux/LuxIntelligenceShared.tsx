...
import {
  Globe, Brain, Clock, AlertCircle, CheckCircle2, Loader2,
  Linkedin, Instagram, Twitter, ExternalLink, Share2
} from 'lucide-react';
...
export const SocialProfileCard = ({ profile }: { profile: SocialProfile }) => {
...
export const StakeholderCard = ({ stakeholder, index }: { stakeholder: Stakeholder; index: number }) => (
  <motion.div
