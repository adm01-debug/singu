          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <Tabs defaultValue="contacts" className="w-full">
                ...
                <TabsContent value="data" className="mt-4 space-y-4"><DashboardErrorBoundary sectionName="Dados"><CompanyDataTab cnaes={cnaesHook.data} rfmScores={rfmHook.data} stakeholders={stakeholdersHook.data} loading={cnaesHook.isLoading || rfmHook.isLoading || stakeholdersHook.isLoading} /></DashboardErrorBoundary><DashboardErrorBoundary sectionName="Campos Personalizados"><CustomFieldsDisplay entityType="company" entityId={id!} /></DashboardErrorBoundary><DashboardErrorBoundary sectionName="Dados Enriquecidos"><CompanyEnrichedCard companyId={id!} /></DashboardErrorBoundary><DashboardErrorBoundary sectionName="Duplicatas"><CompanyDuplicatesPanel /></DashboardErrorBoundary></TabsContent>
