...
export default function AdminTelemetriaPage() {
  ...
  const getSeverityBadge = (severity: string) => {
    switch (severity) {
      case "very_slow":
        return <Badge variant="destructive" size="sm">🔴 Muito Lenta</Badge>;
      case "slow":
        return <Badge variant="warning" size="sm">🟡 Lenta</Badge>;
      case "error":
        return <Badge variant="destructive" size="sm">❌ Erro</Badge>;
      default:
